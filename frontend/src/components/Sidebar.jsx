...
const Sidebar = ({
    ...
    return (
        <aside className="w-80 h-screen fixed left-0 top-0 overflow-y-auto z-50 font-sans glass-dark text-cream flex flex-col shadow-2xl border-right border-white/5 transition-all duration-500">
            {/* Header */}
